...
class RemoveFromCart extends React.Component {
  ...
  //the cache is the Apollo cache(we can read directly into it)
  //payload is the information that gets returned from the server which will be the ID of the mutation that was resolved
